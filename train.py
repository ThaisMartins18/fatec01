...
exp_name = "/Users/thaisfmartins18@gmail.com/fatec_dota_thais"
...
X_train, X_test, y_drain, y_test = model_selection.train_test_split(df[features], df[target], test_size=0.2, random_state=42)
